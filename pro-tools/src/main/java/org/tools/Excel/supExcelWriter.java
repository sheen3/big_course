    ...
    public void writeToExcel(String folderName, String fileName, String[] content) {
        ...
        try (FileInputStream fis = new FileInputStream(excelFilePath);
            ...
            Sheet sheet = workbook.getSheet("Sheet1");
                ...
                headerRow.createCell(0).setCellValue("超市编号");
                headerRow.createCell(1).setCellValue("超市名称");
                headerRow.createCell(2).setCellValue("超市地址");
                headerRow.createCell(3).setCellValue("超市联系方式");
